    ...
    foreach($_POST['checkBoxArray'] as $checkBoxId){
        ...
        switch($bulk_options){
            case 'Publish':
                ...
                $update_to_publish= mysqli_query($conn, $query);
...
if(isset($_GET['reset'])){
    $the_post_id= $_GET['reste'];
    $query= "UPDATE posts SET post_view_counts=0 WHERE post_id =" .mysqli_real_escape_string($conn, $_GET['reset']) ." ";
